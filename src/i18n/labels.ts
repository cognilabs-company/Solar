...
const USER_PERMISSION_LABEL_KEYS: Record<string, string> = {
  ...
  can_view_warehouse: 'labels.permissions.can_view_warehouse',
  can_manage_warehouse: 'labels.permissions.can_manage_warehouse',
...
const USER_PERMISSION_DESCRIPTION_KEYS: Record<string, string> = {
  ...
  can_view_warehouse: 'labels.permissionDescriptions.can_view_warehouse',
  can_manage_warehouse: 'labels.permissionDescriptions.can_manage_warehouse',
